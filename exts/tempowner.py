...
class Owner(commands.Cog, name="Owner"):
    ...
    async def cog_check(self, ctx):
        return ctx.author.id == (await ctx.bot.application_info()).owner.id or ctx.author.id in [1941941545468, 456456749841568, 456748944564] #or ctx.author.id == 397029587965575170
